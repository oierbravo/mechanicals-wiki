...
<img width="300" height="300" src="/extruder-logo.png" alt="Logo"/>

> A mechanical extruder block.
> Can be used to generate any block or item from adjacent blocks/fluids.
